...
class FRCNN(object):
    _defaults = {
        ...
        #--------------------------------------------------------------------------#
        "model_path"    : 'logs/ep028-loss0.886-val_loss0.660.pth',
    ...
    def __init__(self, **kwargs):
        ...
        # repeat() : 重复 5 遍， std为 (1, 20)的tensor
        ...
        #   画框设置不同的颜色
        #---------------------------------------------------#
        # hsv_tuples= [(0.0, 1.0, 1.0), (0.3333333333333333, 1.0, 1.0), (0.6666666666666666, 1.0, 1.0)]
        hsv_tuples = [(x / self.num_classes, 1., 1.) for x in range(self.num_classes)]
        # lambda x: colorsys.hsv_to_rgb(*x) 相当于是一个函数
        # 在列表前加*号，会将列表拆分成一个一个的独立元素
    ...
    def generate(self):
        ...
        # eval() : 不启用 BatchNormalization 和 Dropout，保证BN和dropout不发生变化
